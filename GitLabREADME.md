...
### CI/CD Settings
- Add Variable SERVICE_ACCOUNT_[BRANCH_NAME]:
- [Settings-> CI/CD](https://gitlab.com/gcp-solutions/hcls/claims-modernization/pa-ref-impl/DRLS-GCP/-/settings/ci_cd)
Examples: `SERVICE_ACCOUNT_gcpDev`  (keep the case exact)
    - Download json key, copy/paste and save it as a Variable inside 
    - File into CI/CD SERVICE_ACCOUNT_<branch_name>.json
    - Type: File
...
- Manually Run 'cluster_prepare' Job to get your cluster ready
- Now you can Manually run 'Deploy' 

TODO:
> check_cluster --> first step of deployment
> use Service_Account_<branch>.json
> use default branch for images
> Upload CDS-Library to Cloud Storage
